    ...
    <div className="fixed right-0 top-1/2 -translate-y-1/2 z-40 print:hidden font-sans select-none">
      ...
      >
        ...
        <div className="flex items-center gap-2 px-1">
          <ShoppingBag className="w-5 h-5 text-white stroke-1.5 shrink-0" />
        ...
        <div className="mt-2 bg-white text-neutral-950 font-extrabold text-[11px] sm:text-xs px-2.5 py-1 rounded-sm whitespace-nowrap tracking-tight">
          {formattedPrice}
        </div>
      </button>
    </div>
